...
public class Scanner {
			...
			// multi-line comment
				...
				if (eot) {
					return new Token(TokenKind.ERROR, "Expecting end of comment, but not found",
							new SourcePosition(this.line, this.col));
				}
			} else {
	...
	private void scanError(String m) {
		reporter.reportError("Scan Error:  " + m + " at " + "line: " + this.line + ",column: " + this.col + ";");
	}
	...
	/**
	 * advance to next char in inputstream detect end of file or end of line as
	 * end of input
	 */
