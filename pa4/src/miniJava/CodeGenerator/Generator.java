...
//		pd.entity.fieldDis = (int) offset;
	...
	public Object visitAssignStmt(AssignStmt stmt, Object arg) {
		if(stmt.ref instanceof IdRef){
			...
			if(fd.isStatic){
				stmt.val.visit(this, Action.fetch);
				Machine.emit(Op.STORE,Reg.SB,fd.entity.staticFieldDis); // store into var
			}
			else{
...
/**************************************************************************/
	public boolean isMain(MethodDecl md){
		...
		isMain = md.isStatic && md.type.typeKind == TypeKind.VOID
				&& md.parameterDeclList.size() == 1 && md.name.equals("main");
		if(isMain){
